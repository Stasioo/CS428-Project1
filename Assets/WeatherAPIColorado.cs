...
public class WeatherAPIColorado : MonoBehaviour
{
    public GameObject weatherTextObject;
    // add your personal API key after APPID= and before &units=
    string url = "http://api.openweathermap.org/data/2.5/weather?lat=39.2130&lon=-106.9378&APPID=8823edeeb1a89fe6bdccd78af787d2d0&units=metric";


    void Start()
    {

        // wait a couple seconds to start and then refresh every 600 seconds (10mins)
